...
import {noImage} from "../assets/nobookicon.png";
import 'antd/dist/antd.css';
import '../css/InserForm.css';
const { TextArea } = Input;
const  imgUrl = require("../assets/nobookicon.png");
export class BookInsertForm extends React.Component{
    ...
    submit = () => {
        ...
        insertBook(this.state,callback);
    };
            ...
            >
                <div className="modalImageSpace" style={{display:"flex",marginLeft:"105px"}}>
                    <div style={{display:"flex",alignItems:"center",justifyContent:"center",minWidth:"102px",height:"102px",backgroundColor:"rgb(238,238,238)"}}>
                        <img alt="image" src={imgUrl} style={{width:"102px",height:"102px"}}/>
                    </div>
